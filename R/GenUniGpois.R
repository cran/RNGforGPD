...
#' @param details index to indicate whether or not to print out the estimates of parameters.
#'  The default is set as TRUE.
#' @param method index to specify one of the five methods: "Inversion", "Branching", "Normal-Approximation", "Build-Up" and "Chop-Down".
#' @details
